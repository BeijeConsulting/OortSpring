...
public class ContattoSpring {
	...
	public ContattoSpring() {}
	
	public ContattoSpring(String nome, String cognome, String telefono) {
		this(nome, cognome, telefono, "");
	}
	
	public ContattoSpring(String nome, String cognome, String telefono, String email) {
		this.nome = nome;
...
//	}
	...
	public boolean equals(ContattoSpring c) {
